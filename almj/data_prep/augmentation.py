...
from almj.utils.audio_utils import WAVFile, float_to_wav, wav_to_float
...
class SoxAugmentation:
    ...
    def __init__(self, RIRs_dir=None, background_sound_dir=None, colored_noise_dir=None):
        ...
        if background_sound_dir is not None and Path(background_sound_dir).exists():
            ...
            logging.warning(f"Background sound directory {background_sound_dir} does not exist, not using background sounds")
